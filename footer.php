        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <div>
                    <?php echo do_shortcode( '[contact-form-7 id="160" title="Форма вопросов"]' ) ?>
                </div>
            </div>
        </div>
        <footer>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('instagram') ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('facebook') ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('youtube') ?>" class="footer__social-item">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    ...
                                    <a href="tel:<?php the_field('second_phone', 2); ?>"><?php the_field('second_phone', 2); ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
