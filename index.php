...
?>
                ...
                <ul class="glide__slides">
                    <?php 
                        ...
                        foreach( $my_posts as $post ){
                            setup_postdata( $post ); // далее разрыв php кода
                            ?> 
                                <li style="background-image: url('<?php echo the_field('slider_img'); ?>')" class="glide__slide">
                                    <div class="container">
                                        <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('toys_alert_bold') ?></span><?php the_field('toys_alert') ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('aboutus_img_first') ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('aboutus_img_second') ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('aboutus_subtitle_third') ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('aboutus_descr_third') ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('aboutus_img_third') ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="contacts" id="contacts">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="title contacts__minititle"><?php the_field('contacts_subtitle_first') ?></div>
                        <div class="contacts__info">
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    <?php the_field('contacts_phone_first') ?>
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('contacts_phone_number_first') ?>"><?php the_field('contacts_phone_number_first') ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    <?php the_field('contacts_phone_second') ?>
                                    <div class="contacts__phonewrap">
                                        <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M13.4887 0.000305176H5.51165C4.74276 0.000305176 4.1167 0.626369 4.1167 1.39525V17.6055C4.1167 18.3747 4.74276 19.0007 5.51165 19.0007H13.4883C14.2575 19.0007 14.8836 18.3747 14.8836 17.6058V1.39525C14.8836 0.626369 14.2575 0.000305176 13.4887 0.000305176ZM4.75005 2.5337H14.2503V14.5673H4.75005V2.5337ZM5.51165 0.633653H13.4883C13.9086 0.633653 14.2503 0.975344 14.2503 1.39525V1.90035H4.75005V1.39525C4.75005 0.975344 5.09174 0.633653 5.51165 0.633653ZM13.4887 18.3674H5.51165C5.09174 18.3674 4.75005 18.0257 4.75005 17.6058V15.2006H14.2503V17.6058C14.2503 18.0257 13.9086 18.3674 13.4887 18.3674Z" fill="url(#paint0_linear)"/>
                                            <path d="M9.49961 15.5173C8.80102 15.5173 8.23291 16.0854 8.23291 16.784C8.23291 17.4826 8.80102 18.0507 9.49961 18.0507C10.1982 18.0507 10.7663 17.4826 10.7663 16.784C10.7663 16.0854 10.1982 15.5173 9.49961 15.5173ZM9.49961 17.4174C9.15031 17.4174 8.86626 17.1333 8.86626 16.784C8.86626 16.4347 9.15031 16.1507 9.49961 16.1507C9.8489 16.1507 10.133 16.4347 10.133 16.784C10.133 17.1333 9.8489 17.4174 9.49961 17.4174Z" fill="url(#paint1_linear)"/>
                                        ...
                                        <a href="tel:<?php the_field('contacts_phone_number_second') ?>"><?php the_field('contacts_phone_number_second') ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="contacts__mail">
                                <?php the_field('contacts_mail_subtitle') ?>
